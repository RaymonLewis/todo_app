...
//We must redone it to be able to use for the task removal since it looks the same.
export default function RemoveButton({ listName, taskID, removeList, removeTask, parent }) {
  ...
  return (
    <button className="remove-list-btn" onClick={handleClick}>
      <i className="remove-list-btn__icon">
